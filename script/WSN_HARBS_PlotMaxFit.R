...
plotheatmap <- function(filename, graphname, n, h, w){
...
m1 <- plotheatmap('result/WSN_MaxFitMut_1.tsv','graph/WSN_MaxFitMut_1.png',0, 6, 7)
m2 <- plotheatmap('result/WSN_MaxFitMut_2.tsv','graph/WSN_MaxFitMut_2.png',0, 6, 7)
m3 <- plotheatmap('result/WSN_MaxFitMut_3.tsv','graph/WSN_MaxFitMut_3.png',225, 2, 7)
t1 <- m1 %>%
        arrange(value) %>%
...
ggsave('graph/WSN_MaxFitMut_Dist.png',p,width=3.5,height=3)
